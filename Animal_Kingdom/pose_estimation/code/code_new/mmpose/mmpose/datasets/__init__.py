...
from .datasets import (  # isort:skip
    AnimalATRWDataset, AnimalFlyDataset, AnimalHorse10Dataset, AnimalKingdomDataset,
...
__all__ = [
    ...
    'AnimalFlyDataset', 'AnimalKingdomDataset', 'AnimalLocustDataset', 'AnimalZebraDataset',
